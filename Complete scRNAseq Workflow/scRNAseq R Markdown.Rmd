---
title: "Complete scRNAseq Workflow"
author: "Asad"
date: "2023-05-27"
output:
  pdf_document: 
...
high fraction of mitochondrial counts are indicative of cells whose cytoplasmic mRNA has leaked out through a broken membrane, and thus, only mRNA located in the mitochondria is still conserved.
...
to include for further downstream analyses. The impression from the dim plot
below is that PC1 and PC2 separetes the cell population into half whereas other PCs
...
#### Elbowplot 
It suggests that at around 15th PC, the hetereogeneity among the dimensions 
identified drops significantly

#### Another alternative way
JackStraw method takes random identified dimendions and utilizes statistical model
to assign p-value. This usually takes time for larger dataset and depends on
computational power.Elbowplot is advised to use.
```{r}
